...
abstract class Table extends ZfQueryBasedTable
{
    /** @var TableColumn[] */
    ...
    public function removeAvailableColumn($columnAlias)
    {
        unset($this->availableColumns[$columnAlias]);
    ...
    protected function renderTitleColumns()
    {
        ...
        return static::row($columns, ['data-base-target' => '_self'], 'th');
    }
}
